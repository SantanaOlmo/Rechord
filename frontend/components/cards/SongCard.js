        ...
        <div class="card-image h-32 md:h-48 w-full relative overflow-hidden">
            ...
            <div class="absolute top-2 right-2 flex flex-col items-center z-20">
                <button class="like-btn p-1.5 rounded-full bg-black/40 backdrop-blur-sm hover:bg-black/60 transition" 
                    ...
                    <svg class="w-4 h-4 md:w-5 md:h-5 ${isLiked ? 'text-red-500 opacity-100' : 'text-white opacity-70 hover:opacity-100'}" fill="${isLiked ? 'currentColor' : 'none'}" stroke="currentColor" viewBox="0 0 24 24">
