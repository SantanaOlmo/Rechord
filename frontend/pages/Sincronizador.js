...
export function render(songId) {
    ...
    return `
        <div class="h-screen flex flex-col bg-black text-white font-sans select-none overflow-hidden">
            
            <!-- 1. Top Header -->
            <header class="h-14 border-b border-gray-800 bg-gray-900 flex items-center justify-between px-4 shrink-0 z-40 relative shadow-sm">
                <!-- Left: Back Button -->
            ...
            <div class="flex-1 flex overflow-hidden min-h-0 relative gap-[5px] px-[5px] pt-[5px]">
                
                <!-- Left Sidebar: Preferences / Navigation -->
                <div id="editor-sidebar" class="w-96 bg-gray-900 flex flex-col z-30 shrink-0 rounded-xl overflow-hidden border border-gray-800/50 shadow-inner">
                    <div class="flex flex-1 overflow-hidden">
                        <!-- Navigation Rail -->
                        <div class="w-16 bg-gray-950 flex flex-col items-center py-4 border-r border-gray-800 gap-4 shrink-0 z-20 justify-evenly">
                        ...
                        <div class="flex-1 flex flex-col bg-gray-900 overflow-hidden relative">
                                ...
                                <div class="flex-1 overflow-hidden relative group">
                                    ...
                                    <div id="lyrics-mode-raw" class="absolute inset-0 flex flex-col p-4">
                                        <div class="flex-1 relative group">
                                            <textarea id="editor-lyrics-raw" class="w-full h-full bg-gray-950 text-gray-300 text-sm p-4 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 border border-gray-800 shadow-inner overflow-y-auto scrollbar-hide transition-colors placeholder-gray-600" placeholder="Escribe o pega la letra aquí...\n\nUsa líneas en blanco para separar estrofas."></textarea>
                            ...
                            <!-- PANEL: CHORDS -->
                            <div id="panel-chords" class="editor-panel hidden flex-col h-full p-4 relative">
                                <!-- Editable Chord Name -->
                                <h3 id="chord-name" class="text-xl font-bold text-gray-200 text-center mb-6 cursor-pointer hover:text-indigo-400 transition" title="Doble click para editar">Cm/ Do menor</h3>
                                
                                <div class="flex-1 flex items-center justify-center relative">
                                    
                                    <!-- Fret Selector (Left) -->
                                    <div id="fret-selector-container" class="w-20 h-64 bg-gray-900 border border-gray-800 rounded-lg shadow-inner flex flex-col items-center justify-center overflow-hidden cursor-ns-resize mr-4 relative select-none">
                                        <div id="fret-selector-list" class="flex flex-col gap-0 z-10 w-full h-full px-1">
                                            <!-- Injected by JS -->
                                        </div>
                                    </div>

                                    <!-- Guitar Grid (Center) -->
                                    <div class="relative w-72 h-64 bg-gray-900/20 border border-gray-700 rounded select-none p-2 mx-2">
                                        <div id="guitar-grid" class="w-full h-full relative">
                                            <!-- Injected by JS: Strings, Frets, Dots -->
                                        </div>
                                    </div>

                                    <!-- Right Tools (Barre Hand) -->
                                    <div class="w-12 h-64 flex flex-col items-center ml-4 pt-4">
                                        <button id="btn-barre" class="group flex items-center justify-center p-2 rounded hover:bg-gray-800 transition" title="Cejilla (Traste 1)">
                                            <!-- Hand Icon (pointer.svg) -->
                                            <svg class="w-8 h-8 text-gray-500 group-hover:text-indigo-400 transform rotate-90 scale-y-[-1]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                <path fill="currentColor" fill-rule="evenodd" d="M424.323 469.333V290.51l-143.06-47.686V111.686c0-26.336-21.35-47.686-47.686-47.686s-47.686 21.35-47.686 47.686v214.589l-35.765-32.785c-20.235-18.549-51.293-18.549-71.529 0c-18.912 17.336-20.19 46.721-2.854 65.634q.682.744 1.396 1.457l108.752 108.752z"/>
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="text-xs text-gray-600 text-center mt-4">
                                    Click en traste para marcar • Scroll en números para mover
                                </div>
                            </div>
                            ...
                            <div id="panel-settings" class="editor-panel hidden flex-col h-full bg-gray-900 overflow-y-auto scrollbar-hide">
                                <div class="px-3 py-2 border-b border-gray-800 bg-gray-900 shrink-0 sticky top-0 z-10">
                            ...
                            <!-- PANEL: SHORTCUTS -->
                            <div id="panel-shortcuts" class="editor-panel hidden flex-col h-full bg-gray-900 overflow-y-auto scrollbar-hide">
                                <div class="px-4 py-3 border-b border-gray-800 bg-gray-900 shrink-0 sticky top-0 z-10">
                ...
                <!-- Right: Verse Display -->
                <div class="flex-1 flex flex-col relative bg-gray-950/50 rounded-xl overflow-hidden border border-gray-800/50 shadow-inner">
                    ...
                    <!-- Global Playback Bar (Moved here to sit above timeline) -->
                     <div class="h-14 border-t border-gray-800 bg-gray-900 flex items-center px-4 justify-between z-10 gap-4">
            ...
            <!-- 3. Bottom Timeline -->
            <div class="shrink-0 relative bg-gray-950 flex flex-col h-auto z-50 shadow-inner m-[5px] rounded-xl overflow-hidden border border-gray-800/50" id="timeline-container">
                
                <!-- Time Ruler (Sticky) -->
                <div class="h-8 border-b border-gray-800 bg-gray-900/95 w-full flex shrink-0 z-20">
                ...
                <div class="flex-1 flex overflow-hidden relative">
                    ...
                    <div class="w-48 bg-gray-900 border-r border-gray-800 flex flex-col shrink-0 z-20 shadow-lg" id="headers-container">
                         <!-- Injected by rendering.js -->
                    </div>

                    <!-- Scrollable Tracks Content -->
                    <div class="flex-1 overflow-x-auto overflow-y-hidden relative scrollbar-hide bg-gray-950" id="timeline-scroll-area">
